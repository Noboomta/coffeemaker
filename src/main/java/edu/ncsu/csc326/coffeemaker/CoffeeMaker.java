...
public class CoffeeMaker {
    ...
    /**
     * Constructor for the coffee maker (no param added)
     *
     */
	public CoffeeMaker() {
	...
	/**
	 * Constructor for the coffee maker (with 2 params)
	 *
	 * @param recipeBook outside RecipeBook
	 * @param inventory outside Inventory
	 */
